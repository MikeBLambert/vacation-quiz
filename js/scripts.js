...
function vacationDecision (bigCities, introverted, singing, ocean) {
...
//User Interface
//A value for each variable is determined based on which radio input is selected. These variables are 1, 2, 10, 20, 100, 200, 1000, and 2000.
$(document).ready(function() {
  ...
  $(".question#q4").submit(function(event) {
    ...
    var q4Answer = $("input:radio[name=optradio4]:checked").val();
      ...
      $(".question#q2").hide();
      $(".question#q4").hide();
      $(".result").html("You should go to "+ vacationDecision(bigCities, introverted, singing, ocean) + "!");
  });
  });
  });
  });
